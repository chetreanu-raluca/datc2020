...
namespace L05
{
    public class MetricsRepository
    {
        ...
        {
            _connectionString = "DefaultEndpointsProtocol=https;AccountName=ralucadatc2020;AccountKey=2e9McFczsCmSm+kxytIKgi2r52mIHkaBloO8PVhZQB83qpAq8WJPIQk6VcqHMHLI8iso+9G/CCxP5gaNrN+jAw==;EndpointSuffix=core.windows.net"; //connection string copiat de pe Azure storage
